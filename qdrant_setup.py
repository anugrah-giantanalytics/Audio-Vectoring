...
if __name__ == "__main__":
    # Qdrant Cloud URL and API key should be set as environment variables
    QDRANT_URL = os.environ.get("QDRANT_URL")
    QDRANT_API_KEY = os.environ.get("QDRANT_API_KEY")
    
    if QDRANT_URL and QDRANT_API_KEY:
        # Connect to Qdrant Cloud (preferred for production use)
        ...
        # Fall back to in-memory for testing if no cloud credentials
        connector = QdrantConnector(in_memory=True)
        print("No Qdrant Cloud credentials found. Using in-memory instance.")
        print("For better performance with large audio files, set QDRANT_URL and QDRANT_API_KEY")
        print("Sign up at https://cloud.qdrant.io/ to get a URL and API key")
